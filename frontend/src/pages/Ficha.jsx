        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">
              Marcos Silva (Vulgo: "Ligeiro")
            </h1>
            <p className="text-sm text-gray-500">
              CPF: 123.456.789-00 • 34 anos • Reincidente
            </p>
          </div>
        </div>
          ...
          {activeTab === "dados" && (
            <div className="bg-white p-6 rounded-2xl border border-gray-100">
              ...
              <p className="text-gray-600 italic">
                Aqui entrarão os dados que preenchemos no formulário de
                cadastro...
              </p>
            </div>
          )}
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
              <ShieldAlert size={18} className="text-red-600" /> Alertas de
              Segurança
            </h3>
  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-3">
      ...
      <div className="pt-3 border-t border-gray-50 flex gap-2">
        <button className="text-xs text-gray-400 hover:text-blue-600 transition">
          Editar
        </button>
        <button className="text-xs text-gray-400 hover:text-red-600 transition">
          Excluir
        </button>
      </div>
    </div>
